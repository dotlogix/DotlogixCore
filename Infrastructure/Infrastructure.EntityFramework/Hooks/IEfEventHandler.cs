...
namespace DotLogix.Infrastructure.EntityFramework.Hooks {
    public interface IEfEventHandler {
        /// <summary>
        ...
        /// <summary>
        /// Invoked each time an entity changes it's state. If an entity is newly added to the db context it is only track-able with the <see cref="IEfEventHandler.EntityTracked"/> event
        /// </summary>
