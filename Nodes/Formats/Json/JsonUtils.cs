...
namespace DotLogix.Core.Nodes.Formats.Json {
    ...
    public static class JsonUtils {
        ...
        /// </summary>
        public static string ToJson(this Node value, JsonConverterSettings converterSettings = null) {
            return ToJson(value, value?.GetType(), converterSettings);
        }

        /// <summary>
        /// Convert an object to json text
        /// </summary>
        public static string ToJson(object value, JsonConverterSettings converterSettings = null) {
            return ToJson(value, value?.GetType(), converterSettings);
        }
        ...
        /// Convert an object to json text
        /// </summary>
        public static void ToJson(object value, Stream stream, Encoding encoding, JsonConverterSettings converterSettings = null) {
            ToJson(value, value?.GetType(), stream, encoding, converterSettings);
        }

        /// <summary>
        /// Convert an object to json text
        /// </summary>
        public static void ToJson(object value, TextWriter writer, JsonConverterSettings converterSettings = null) {
            ToJson(value, value?.GetType(), writer, converterSettings);
        }

        /// <summary>
        /// Convert an object to json text
        /// </summary>
        public static string ToJson(object value, Type instanceType, JsonConverterSettings converterSettings = null)
        {
            converterSettings ??= JsonConverterSettings.Default;

            using var writer = new StringWriter(new StringBuilder(StringBuilderCapacity));
            ToJson(value, instanceType, writer, converterSettings);
        ...
        /// Convert an object to json text
        /// </summary>
        public static void ToJson(object value, Type instanceType, Stream stream, Encoding encoding, JsonConverterSettings converterSettings = null)
        {
        ...
        /// </summary>
        public static void ToJson(object value, Type instanceType, TextWriter writer, JsonConverterSettings converterSettings = null) {
            using var nodeWriter = new JsonNodeWriter(writer, converterSettings, StringBuilderCapacity);

            if(value is Node node) {
                using var nodeReader = new NodeReader(node);
                nodeReader.CopyTo(nodeWriter);
            } else {
                NodeUtils.WriteTo(null, value, instanceType, nodeWriter, converterSettings ?? JsonConverterSettings.Default);
            }
        }
        #endregion
        ...
        /// </summary>
        public static TInstance FromJson<TInstance>(string json, JsonConverterSettings settings = null) {
        ...
        /// </summary>
        public static TInstance FromJson<TInstance>(Stream stream, Encoding encoding, JsonConverterSettings settings = null) {
        ...
        /// Convert json text to an instance of object asynchronously
        /// </summary>
        public static TInstance FromJson<TInstance>(TextReader reader, JsonConverterSettings settings = null) {
        ...
        /// Convert json text to an instance of object
        /// </summary>
        public static object FromJson(string json, Type instanceType, JsonConverterSettings settings = null) {
            settings ??= JsonConverterSettings.Default;
        ...
        /// Convert json text to an instance of object asynchronously
        /// </summary>
        public static object FromJson(TextReader reader, Type instanceType, JsonConverterSettings settings = null) {
            settings ??= JsonConverterSettings.Default;
        ...
        /// Convert json text to an instance of object asynchronously
        /// </summary>
        public static object FromJson(Stream stream, Encoding encoding, Type instanceType, JsonConverterSettings settings = null)
        {
            using var reader = new StreamReader(stream, encoding ?? Encoding.UTF8);
