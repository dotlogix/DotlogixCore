...
namespace DotLogix.Core.Rest.Events {
    public class WebServiceEvent : IWebServiceEvent {
        ...
        public void Subscribe(IAsyncHttpContext context, IWebServiceRoute route, WebServiceRouter router) {
        ...
        protected virtual WebServiceEventSubscription CreateSubscription(IAsyncHttpContext context, IWebServiceRoute route, WebServiceRouter router) {
