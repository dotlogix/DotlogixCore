...
namespace DotLogix.Core.Extensions {
    public static class TypeExtension {
        ...
        /// <summary>
        /// Gets a more readable name for generic types (including the the generic argument names) or the type name if the type is not generic.
        /// </summary>
        /// <param name="type">The type</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Determines if a type is assignable to an open generic type, also returns the generic arguments of the constructed generic type
        /// </summary>
        /// <param name="sourceType">The type to check</param>
        /// <param name="targetType">The open generic type</param>
        ...
        /// <summary>
        /// Creates an instance of a generic type using the provided generic arguments using the constructor with matching parameters
        /// </summary>
        /// <param name="genericType">The type to instantiate</param>
        /// <param name="genericArguments">The generic arguments to build the type</param>
